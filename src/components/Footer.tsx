  ...
  return (
    <footer className="bg-[#080909] text-white">
      <div className="mx-auto grid max-w-7xl gap-4 px-4 py-10 sm:px-5 md:grid-cols-2 md:gap-8 lg:grid-cols-4 lg:px-8 lg:py-12">
        <div className="rounded-2xl border border-white/10 p-5 md:border-0 md:p-0"><div className="mb-6 inline-flex rounded-xl bg-white px-3 py-2 shadow-sm">
          <Image
            src="/images/logo/pietra-logo-cropped.png"
            alt="Marmolería Pietra"
            width={150}
            height={70}
            className="h-auto w-[115px] object-contain sm:w-[130px] md:w-[140px]"
          />
